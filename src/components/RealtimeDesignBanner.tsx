...
const RealtimeDesignBanner: React.FC = () => {
    return (
        <div>
            <p className="font-[500] text-[20px] md:text-[32px] md:leading-[20px] md:leading-[32px] -tracking-[.04em] mt-[120px] md:mt-[150px] mb-[10px] md:mb-[30px]">Что будет на эфире?</p>
