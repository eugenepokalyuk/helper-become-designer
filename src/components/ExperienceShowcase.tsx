...
const ExperienceShowcase: React.FC = () => {
    return (
        <div className='mt-14 md:mt-28'>
            ...
            <div className='max-md:hidden'>
                <div className='flex flex-wrap font-[500] text-[28px] leading-[28px] -tracking-[0.04em] mr-4 flex items-center mt-8'>Клиенты студии это
                    <span className="flex items-center"><YandexIcon className='mx-2' />Яндекс</span>
                    <span className="flex items-center"><SberIcon className='mx-2' />Сбер</span>
                    <span className="flex items-center"><VkusvillIcon className='mx-2' />Вкусвилл</span>
                </div>

                <div className='flex flex-wrap font-[500] text-[28px] leading-[28px] -tracking-[0.04em] mr-4 flex items-center my-1'>
                    <span className="flex items-center"><FiveIcon className='mr-2' />Пятёрочка</span>
                    <span className="flex items-center"><KFCIcon className='mx-2' />KFC</span>
                    <span className="flex items-center"><TechnoIcon className='mx-2' />ТЕХНОНИКОЛЬ</span>
                </div>

                <div className='flex flex-wrap font-[500] text-[28px] leading-[28px] -tracking-[0.04em] mr-4 flex items-center my-1'>
                    <span className="flex items-center"><LentaIcon className='mr-2' />Лента</span>
                    <span className="flex items-center"><ChijikIcon className='mx-2' />Чижик</span>
                    <span className="flex items-center"><DocmedIcon className='mx-2' />Doc med</span>
                </div>
            </div>

            <div className='md:hidden flex flex-wrap font-[500] text-[28px] leading-[28px] -tracking-[0.04em] mr-4 flex items-center mt-8 space-y-1'>Клиенты студии это
                <span className="flex items-center mr-2"><YandexIcon className='mr-2' />Яндекс</span>
                <span className="flex items-center mr-2"><SberIcon className='mr-2' />Сбер</span>
                <span className="flex items-center mr-2"><VkusvillIcon className='mr-2' />Вкусвилл</span>
                <span className="flex items-center mr-2"><FiveIcon className='mr-2' />Пятёрочка</span>
                <span className="flex items-center mr-2"><KFCIcon className='mr-2' />KFC</span>
                <span className="flex items-center mr-2"><TechnoIcon className='mr-2' />ТЕХНОНИКОЛЬ</span>
                <span className="flex items-center mr-2"><LentaIcon className='mr-2' />Лента</span>
                <span className="flex items-center mr-2"><ChijikIcon className='mr-2' />Чижик</span>
                <span className="flex items-center mr-2"><DocmedIcon className='mr-2' />Doc med</span>
            </div>
            ...
            <div className="md:hidden rounded-[30px] overflow-hidden mt-8 w-full h-[580px]">
                <video src={video} className="w-auto h-full rounded-[30px]" autoPlay muted style={{
                    objectFit: 'cover',
                    transform: 'scale(1.5)'
                }} />
            </div>
